...
Insert Into `account` (`a_id`, `a_account`, `a_password`, `a_name`, `a_last_datetime`, `a_create_datetime`, `a_role`) 
                    VALUES ('8', '123', '202cb962ac59075b964b07152d234b70', "123", NULL, '2018-03-20 13:02:33', "1")
                        , ('9', 'common', '9efab2399c7c560b34de477b9aa0a465', "common", NULL, '2018-03-20 13:44:17', "1")
                        , ('10', 'admin', '21232f297a57a5a743894a0e4a801fc3', "Admin", '2018-04-20 14:46:20', '2018-03-20 13:44:17', "2");
...
CREATE TABLE `wall` ( 
    ...
    `w_color_rgb` varchar(50) NOT NULL,
    PRIMARY KEY (`w_id`)
);
...
CREATE TABLE `region_classification` ( 
    ...
    `rc_attenuation_factor` varchar(50) NOT NULL,
    `rc_last_update_datetime` datetime,
    `rc_create_datetime` datetime,
    `rc_color_rgb` varchar(50) NOT NULL,
    PRIMARY KEY (`rc_id`)
);

Insert Into `region_classification` (`rc_id`, `rc_name`, `rc_attenuation_factor`, `rc_last_update_datetime`, `rc_create_datetime`, `rc_color_rgb`) 
                    VALUES (0, 'Tank Farms', 1.5, '2018-01-01 01:01:01', '2018-01-01 01:01:01', '888888')
                        , (1, 'Building', 1.3, '2018-01-01 01:01:01', '2018-01-01 01:01:01', '009FCC')
                        , (2, 'Light Process Areas', 1.2, '2018-01-01 01:01:01', '2018-01-01 01:01:01', 'DDAA00')
                        , (3, 'Heavy Process Areas', 0.8, '2018-01-01 01:01:01', '2018-01-01 01:01:01', '880000');
