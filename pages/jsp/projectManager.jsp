...
<%
        ...
        try{
            ...
            while(ze!=null){
                ...
                if (fileName.contains("jpg") | fileName.contains("png")| fileName.contains("bmp")| fileName.contains("gif")) {
                    ...
                    // File sourceFile = new File(unpackImagePath);
                    // File targetFile = new File("/opt/tomcat/webapps/III/resources/mapImage/" + fileName);
    ...
    double imgZoom  = Double.parseDouble(request.getParameter("imgZoom"));
